...
- **PHPUnit feature tests** (`./run php artisan test`) — 40 in-process tests: routing, Livewire components, Filament resources/widgets, auth, roles, visibility, wiki-link resolution.
