<div>
    <div class="mb-6">
        <h1 class="font-display text-3xl font-bold tracking-tight text-fg">My courses</h1>
            ...
            @foreach ($rows as $row)
                ...
                <li class="rounded-lg border border-border bg-surface p-4">
                    <div class="flex items-center justify-between gap-3">
                        <a href="{{ route('courses.show', $course->slug) }}" class="font-display text-lg font-bold text-fg hover:text-primary hover:underline">
                            {{ $course->title }}
                        </a>
